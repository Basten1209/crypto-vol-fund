...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| minimum_variance | enter_once_then_drift | 7 | -7.48% | 33.14% | -0.0510 | -28.54% | 13.0000 | 11.15% |
| equal_weight | enter_once_then_drift | 7 | -23.02% | 39.16% | -0.4172 | -36.94% | 13.0000 | 14.00% |
| minimum_variance | daily_rebalance_to_target | 7 | -7.47% | 32.77% | -0.0548 | -28.44% | 14.5251 | 10.99% |
| equal_weight | daily_rebalance_to_target | 7 | -22.12% | 38.93% | -0.3946 | -36.16% | 14.7271 | 13.94% |
| minimum_variance | enter_once_then_drift | 14 | 29.51% | 40.56% | 0.7918 | -29.06% | 13.0000 | 21.56% |
| equal_weight | enter_once_then_drift | 14 | 11.27% | 51.74% | 0.4543 | -35.68% | 13.0000 | 27.57% |
| minimum_variance | daily_rebalance_to_target | 14 | 31.10% | 40.64% | 0.8187 | -29.59% | 16.2045 | 21.16% |
| equal_weight | daily_rebalance_to_target | 14 | 8.54% | 51.76% | 0.4098 | -35.20% | 16.8166 | 27.40% |

## Readout

- For the 7-day minimum variance portfolio, daily rebalancing changes total return from -7.48% to -7.47%, with slightly lower volatility and MDD.
- For the 14-day minimum variance portfolio, daily rebalancing improves total return from 29.51% to 31.10%, with similar volatility and slightly worse MDD.
